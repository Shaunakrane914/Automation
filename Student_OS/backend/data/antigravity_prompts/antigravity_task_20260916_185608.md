# Autonomous Antigravity Execution Directive
...
- **Primary Project Root:** `C:\Users\Shaunak Rane\Desktop\Projects\Automation`
- **Academic Source of Truth:** `c:\Users\Shaunak Rane\Desktop\3rd Year`
- **Git Branch:** `main` (Latest Commit: `7b8da9e Auto-Apply Run: Applied to 10 remote internships using primary portfolio Shaunak_Rane_Resume.pdf`)
...
- **Overall Attendance:** 89.9% across 15 subjects.
- **Pending Assignments:** 20 pending items.
- **Target Scope:** Universal Automation / Student OS Workspace / 3rd Year Academic Directories

## 4. Operational Guidelines (Shaunak Working Style)
1. Thoroughly inspect the existing code structure in `C:\Users\Shaunak Rane\Desktop\Projects\Automation` before modifying files.
...
4. Stage and commit changes with a concise git message and push to `origin main`.
...
- **Primary Workstation Root:** `C:\Users\Shaunak Rane\Desktop\Projects\Automation`
- **Academic Source of Truth:** `C:\Users\Shaunak Rane\Desktop\3rd Year`

## 2. Technical Preferences & Coding Style
- **Python:** Python 3.13+, clean modular architecture, typing hints, Pydantic models.
- **Frontend:** React 19, TypeScript, Tailwind CSS, Lucide icons, dark neutral workstation aesthetics.
- **Backend:** FastAPI, SQLite (WAL mode), WebSockets for real-time progress streaming.
- **Browser Automation:** Playwright with Chrome CDP attachment (port 9222).
- **Automation Philosophy:** Zero unnecessary manual steps; deterministic scripts; clean workspaces with no loose clutter.

## 3. Antigravity Prompting Style & Escalation Preferences
...
---
*Directive Timestamp: 2026-09-16 18:56:08 | Directive File: `antigravity_task_20260916_185608.md`*
