...
with sync_playwright() as p:
    ...
    # Button index 0 is Internshala ML Internship
    btns[0].click()
    ...
    shot_path = r"C:\Users\Shaunak Rane\Desktop\Projects\Automation\Auto Apply\logs\screenshots\student_os_proof_modal_internshala_loaded.png"
