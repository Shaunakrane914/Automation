...
run_non_stop = True                 # Enabled: Bot runs continuously without stopping
'''
...
click_gap = 3                       # Increased to 3 for human-like delays (was 1)
...
safe_mode = False                  # Disabled: Use real user profile with active logins
